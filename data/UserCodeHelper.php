<?php
/**
 * DataObject For Usercode helper of OpenEvSys.
 *
...
class UserCodeHelper{
	...
	public static function deleteFromUserNameFromAction($username,$action){
		$userCode = new UserCode();		
		$userCode->Load("username='" .$username . "' AND action='" . $action . "'");
	}
	 
   public static function loadForUserNameForAction($username , $action){
        $userCode = new UserCode();
        $userCode->Load("username='$username' AND action='$action'" );
