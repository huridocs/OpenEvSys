...
<div class="panel">
    ...
    <div class='alert alert-info'> <button type="button" class="close" data-dismiss="alert">×</button> 
        ...
        <a class="btn" href="<?php get_url('docu','edit_document', null, array('doc_id'=>$supporting_docs_meta->doc_id))?>" ><i class="icon-edit"></i> <?php echo _t('CONTINUE_EDITING_THE_DETAILS_OF_THIS_DOCUMENT')?></a><br />
        <a class="btn" href="<?php get_url('docu','new_document',null)?>"><i class="icon-plus"></i> <?php echo _t('ADD_NEW_DOCUMENT')?></a>
    </div>
