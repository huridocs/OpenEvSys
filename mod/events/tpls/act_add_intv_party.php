...
?>
    ...
    <a class="btn btn-primary" href="<?php echo get_url('events','add_intv_party','new_intv_party',array('eid'=>$event_id)) ?>"><i class="icon-plus icon-white"></i> <?php echo _t('ADD_NEW')?></a>
    <?php } ?>
    ...
    <a class="btn" href="<?php echo get_url('events','add_intv_party','search_intv_party',array('eid'=>$event_id)) ?>"><i class="icon-search"></i> <?php echo _t('SEARCH_IN_DATABASE')?></a>
    <?php } ?>
    <a class="btn" href="<?php echo get_url('events','intv_list',null,array('eid'=>$event_id)) ?>"><i class="icon-stop"></i> <?php echo _t('CANCEL')?></a>
	<?php if(isset($intv_party)){ ?>
	<a class="btn" href="<?php echo get_url('events','add_intv',null,array('eid'=>$event_id)) ?>"><?php echo _t('CONTINUE')?></a>
	<?php } ?>
