...
<div class="panel">
    ...
    <div class="form-container"> 
        ...
        <a class="btn" href="<?php echo get_url('events','intv_list',null,array('eid'=>$event_id,'intervention_id'=>$_GET['intervention_id'],'type'=>'intv')) ?>"><?php echo _t('CANCEL')?></a><span>&nbsp;&nbsp;</span>
        </center>
        </form>
    </div>
</div>
