...
<form id="person_form" name="person_form" action='<?php echo get_url('events','add_intv_party','new_intv_party',array('eid'=>$event_id))?>' method='post' enctype='multipart/form-data'>
