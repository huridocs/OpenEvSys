    ...
    <div class="form-container">
        <form class="form-horizontal"  id="actform" name="actform" action='<?php echo get_url('events', 'edit_act', null, array('eid' => $event_id, 'act_id' => $_GET['act_id'])) ?>' method='post' enctype='multipart/form-data'>
            <div class="control-group">
                <div >
                    <a class="btn" href="<?php echo get_url('events', 'vp_list', null, array('eid' => $event_id, 'act_id' => $_GET['act_id'], 'row' => $_GET['row'], 'type' => 'act')) ?>"><i class="icon-remove-circle"></i> <?php echo _t('CANCEL') ?></a> <span>&nbsp;</span>
