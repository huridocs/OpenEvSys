...
<form id="person_form" name="person_form" action='<?php echo get_url('events','add_source','new_source',array('eid'=>$event_id))?>' method='post' enctype='multipart/form-data'>
	...
	<center>
	<a class="but" href="<?php echo get_url('events','add_source',null,array('eid'=>$event_id)) ?>"><?php echo _t('CANCEL')?></a>
