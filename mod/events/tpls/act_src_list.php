...
?>
			...
			<a class="btn  " href="<?php echo get_url('person','person',null,array('pid'=>$source->person_record_number)) ?>"><i class="icon-zoom-in"></i><?php echo _t('MORE_ABOUT_THIS_PERSON')?></a><?php			
            echo '<br />';
            echo '<br />';
...
?>	
			<br />
			<a class="btn " href="<?php echo get_url('events','edit_information',null,array('eid'=>$event_id,'information_id'=>$_GET['information_id'])) ?>"><i class="icon-edit"></i> <?php echo _t('EDIT_THIS_INFORMATION')?></a>
			<br /><br />
<?php	
