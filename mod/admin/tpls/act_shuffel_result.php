...
<form action='<?php echo get_url('admin','shuffel_result')?>' method='get'>
...
<br />
<div class="panel">
<form action='<?php echo get_url('admin','shuffel_result',null,array('sub_act'=>$_REQUEST['sub_act']))?>' method='post'>
