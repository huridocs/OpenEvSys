...
<div class="form-container">
    <form class="form-horizontal"  action='<?php echo get_url('admin', 'new_field') ?>' method='post'>
        ...
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="field_number" type="text" name="field_number" id="field_number"  value=""   class='input-large'  />
                <div class="help-inline"><span class="label label-important"><?php echo _t('required') ?></span>    </div>
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="field_name" type="text" name="field_name" id="field_name"  value=""   class='input-large'  />
                <div class="help-inline"><span class="label label-important"><?php echo _t('required') ?></span>    </div>
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="field_label" type="text" name="field_label" id="field_label"  value=""  class='input-large'  />
                <div class="help-inline"><span class="label label-important"><?php echo _t('required') ?></span>    </div>
            </div>
        </div>
        ...
        <div class='control-group' id="termsdiv" style="display: none">       
        ...
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="required" type="checkbox" name="required" id="required"  value="y"    />
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="clarify" type="checkbox" checked="checked" name="clarify" id="clarify"  value="y"    />
            </div>
        </div>
        ...
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="visible_new" type="checkbox" checked="checked" name="visible_new" id="visible_new"  value="y"    />
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="visible_view" type="checkbox" checked="checked" name="visible_view" id="visible_view"  value="y"    />
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="visible_browse" type="checkbox"  name="visible_browse" id="visible_browse"  value="y"    />
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="visible_adv_search" type="checkbox" checked="checked" name="visible_adv_search" id="visible_adv_search"  value="y"    />
            </div>
        </div>
        <div class='control-group'>	
            ...
            <div class="controls">
                <input title="visible_adv_search_display" type="checkbox"  name="visible_adv_search_display" id="visible_adv_search_display"  value="y"    />
            </div>
        </div>
        <br style="clear: both" />
        <div class="control-group">
