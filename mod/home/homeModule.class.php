...
//    	$gacl_api = new gacl_api(array('db'=>$global['db'] , 'db_table_prefix'=>'gacl_'));
    	...
    	$gacl_api->add_acl( 	array( 'crud'=>array('create', 'read' , 'update' , 'delete') ) ,
    	 						null ,
    	 						array( $root_aro ),
    	 						array( 'entities' => array(  'person' ,'event' , 'act' , 'information' , 'intervention' , 'involvement' , 'chain_of_events' , 'biographic_details'   ) ) 															
    	 				);
    ...
    function act_get_mt_term(){
        echo get_mt_term($_GET['huricode']);
    }
}
