...
<form class="form-horizontal"  action='<?php echo get_url('admin', 'permissions') ?>' method='post'  style="margin:0px">
    ...
    <?php if ($role != 'admin') { ?>
        ...
        <button type="submit" class="btn btn-primary" name="change_permissions" value="change_permissions" ><i class="icon-ok icon-white"></i> <?php echo _t('UPDATE_PERMISSIONS') ?></button>
