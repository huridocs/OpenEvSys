<?php
 /**	
 * Class for search existing victims and return selected person_record_number.
 *
 * Copyright (C) 2009
...
class PersonVictimSearch {
    ...
    require_once(APPROOT.'mod/analysis/analysisModule.class.php');
    	...
    	$_REQUEST['search_type'] = 'victim';
    	$sqlStatement = $analysisModule->generateSqlforEntity('victim',null,$_REQUEST, 'search');    	
