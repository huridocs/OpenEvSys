...
$translationsFile = APPROOT . "translate" . DIRECTORY_SEPARATOR . "translations.txt";
  ...
  $messages = array(
"Date" => "თარიღი","Author" => "ავტორი","Share" => "გაზიარება",
    "News" => "სიახლეები","Links" => "ბმულები","Articles" => "სტატიები","RSS" => "RSS",
    "Subscribe" => "გამოწერა","in the last 2 weeks" => "ბოლო 2 კვირის განმავლობაში",
    "Title" => "სათაური","Respondent" => "ადმინისტრაციული ორგანო","Sender" => "გამგზავნი",
    "Date Sent" => "გაგზავნის თარიღი","Accomplished" => "დასრულებული","Outcome" => "შედეგი",
    "Empty title" => "უსათაურო","Timeframe violation" => "ვადის დარღვევა",
    "Browse all accomplished requests" => "ძიება ყველა დასრულებული მოთხოვნის მიხედვით",
    "Pending Requests" => "მიმდინარე მოთხოვნები","Update" => "განახლება",
    "Browse all pending requests" => "ძიება ყველა მიმდინარე მოთხოვნის მიხედვით",
    "Send Request" => "მოთხოვნის გაგზავნა","Requesters" => "გამომთხოვნები",
    "Browse all requesters" => "ძიება ყველა განმცხადებლის მიხედვით",
    "Public Institutions" => "საჯარო დაწესებულებები",
    "Browse all institutions" => "ძიება ყველა საჯარო დაწესებულებების მიხედვით",
    "Subordinate Institutions" => "დაქვემდებარებული დაწესებულებები","Public Institution" => "საჯარო დაწესებულება","Date" => "თარიღი","Requests" => "მოთხოვნები ","Browse all" => "ძიება ყველგან","Statistics" => "სტატისტიკა","Forward" => "გადამისამართება","Refusal" => "უარი","Partial" => "ნაწილობრივი","Complete" => "სრულყოფილი","Total" => "სულ","Find Institution" => "დაწესებულების პოვნა","Name" => "სახელი","Search" => "ძიება","Properties" => "რეკვიზიტები","Categories" => "კატეგორიები","Respondents" => "ადმინისტრაციული ორგანოები","(and status)" => "(და სტატუსი)","Date of Submission" => "ჩაბარების თარიღი","Yes" => "დიახ","No" => "არა","Tags" => "თეგი","Attachments" => "დანართები","Correspondence" => "მიმოწერა","Author" => "ავტორი","Files" => "დოკუმენტები","Type" => "სახეობა","Polling" => "გამოკითხვა","Number of requests in last year" => "მოთხოვნების რაოდენობა გასული წლის განმავლობაში","Month" => "თვე","Request by Category" => "მოთხოვნა კატეგორიის მიხედვით","Category" => "კატეგორია","Request By Public Institutions" => "მოთხოვნა საჯარო დაწესებულებების მიხედვით",
    "Number by Outcome" => "რაოდენობა შედეგის მიხედვით","Requests" => "მოთხოვნები","Number by Categories" => "რაოდენობა კატეგორიების მიხედვით",
    "Title, Respondent and Sender" => "სათაური, ადმინისტრაციული ორგანო და განმცხადებელი","Update / Accomplished" => "განახლება / დასრულებული","Prev" => "წინა","Next" => "შემდეგი","Active filters" => "აქტიური ფილტრები","Reset all" => "ყველას გადატვირთვა","Period" => "პერიოდი","Show all" => "ყველას ჩვენება","Filters" => "ფილტრები","Table" => "ცხრილი","Rows" => "რიგები","Columns" => "მწკრივები","Generate Report" => "ანგარიშის მომზადება",
    "Result Table" => "შედეგების ცხრილი"
);
  foreach($dif2 as $v){
  echo $v."\t";
  if($messages[$v]){
